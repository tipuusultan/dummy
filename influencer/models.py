...
class influencer_profile(models.Model):
    ...
    Instagram_page_url = models.URLField(blank=True, max_length=200, null=True)
    Facebook_page_url = models.URLField(blank=True, max_length=200, null=True)
    Youtube_channel_url = models.URLField(blank=True, max_length=200, null=True)
    #categories      
